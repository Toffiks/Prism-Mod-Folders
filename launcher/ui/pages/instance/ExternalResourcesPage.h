...
class ExternalResourcesPage : public QMainWindow, public BasePage {
   ...
   protected:
    ...
    QModelIndex mapViewToSource(const QModelIndex& index) const;
    QModelIndexList mapViewIndexesToSource(const QModelIndexList& indexes) const;
    QItemSelection mapViewSelectionToSource(const QItemSelection& selection) const;
